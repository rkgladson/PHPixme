...
class groupTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function test_callback($arrayLike, $expVal, $expKey)
  {
    P\group(function () use ($arrayLike, $expVal, $expKey) {
      $this->assertTrue(
        3 === func_num_args()
        , 'callback should receive three arguments'
      );
  ...
  public function test_return(
    ...
    , $expected = ["one" => [["one" => 1], ["one" => 2]], "two" => [["two" => 2]]]
  )
  {
    $groupKeys = P\group(function ($value) {
  ...
  public function scenarioProvider()
  {
    ...
    return [
      ...
      , 'S[1,2] * 2' => [
        P\Seq::of(1, 2)
        , $x2
        , P\Seq::from([2 => P\Seq::of(1), 4 => P\Seq::of(2)])
      ]
    ];
  }
}
